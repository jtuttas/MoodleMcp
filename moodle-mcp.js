...
const TOOLS = [
  {
    ...
    description:
      "Ändert den HTML-Inhalt eines bestehenden Text- und Medienfelds (mod_label).",
    inputSchema: {
      type: "object",
      properties: {
        ...
        visible: {
          type: "number",
          description: "1 = sichtbar, 0 = versteckt, -1 = nicht ändern",
          default: -1,
        },
      },
      required: ["cmid"],
  ...
  },
  {
    ...
    description:
      "Ändert Name und/oder Ziel-URL eines bestehenden externen Links (mod_url).",
    inputSchema: {
      type: "object",
      properties: {
        ...
        name: {
          type: "string",
          description: "Neuer Anzeigename (leer = nicht ändern)",
        },
        externalurl: {
          type: "string",
          description: "Neue URL inkl. https:// (leer = nicht ändern)",
        },
        intro: {
          type: "string",
          description: "Neue Beschreibung (leer = nicht ändern)",
        },
        visible: {
          type: "number",
          description: "1 = sichtbar, 0 = versteckt, -1 = nicht ändern",
  ...
  },
  {
    ...
    description:
      "Gibt alle Aktivitäten eines Kurses oder Abschnitts zurück – mit cmid, Typ und Name. Verwenden um cmids für Update-Aufrufe zu ermitteln.",
    inputSchema: {
      type: "object",
      properties: {
        ...
        sectionnum: {
          type: "number",
          description: "Abschnittsnummer (0-basiert, -1 = alle Abschnitte)",
          default: -1,
        },
      },
      required: ["courseid"],
  ...
  },
  {
    ...
    description:
      "Ändert Titel und/oder HTML-Inhalt einer bestehenden Textseite (mod_page). Benötigt die cmid (aus moodle_get_modules oder dem Rückgabewert von moodle_create_page).",
    inputSchema: {
      type: "object",
      properties: {
        ...
        name: {
          type: "string",
          description: "Neuer Titel (leer lassen = nicht ändern)",
        },
        content: {
          type: "string",
          description: "Neuer HTML-Inhalt (leer lassen = nicht ändern)",
        },
        visible: {
          type: "number",
          description: "1 = sichtbar, 0 = versteckt, -1 = nicht ändern",
  ...
  },
  {
    ...
    description:
      "Ändert Titel, Beschreibung und/oder Abgabedatum einer bestehenden Aufgabe (mod_assign). Benötigt die cmid.",
    inputSchema: {
      type: "object",
      properties: {
        ...
        description: {
          type: "string",
          description: "Neue HTML-Beschreibung (leer lassen = nicht ändern)",
        },
        duedate: {
          type: "number",
          description:
            "Neues Abgabedatum als Unix-Timestamp (0 = kein Datum, -1 = nicht ändern)",
          default: -1,
        },
        visible: {
          type: "number",
  ...
  },
  {
    ...
    description:
      "Aktiviert die Abschlussverfolgung fuer eine Aktivitaet. completion=1: SuS klickt manuell 'Abgeschlossen'. completion=2+completionsubmit=1: automatisch bei Einreichung (nur Aufgaben). Muss vor moodle_set_restriction aufgerufen werden.",
    inputSchema: {
      type: "object",
      properties: {
        cmid: {
          type: "number",
          description: "Course Module ID der Aktivitaet",
        },
        completion: {
          type: "number",
          description: "0=keine, 1=manuell, 2=automatisch",
          default: 1,
        },
        completionsubmit: {
          type: "number",
          description: "1=bei Einreichung abschliessen (nur mod_assign)",
          default: 0,
        },
      },
      required: ["cmid"],
  ...
  },
  {
    ...
    description:
      "Sperrt eine Aktivitaet bis bestimmte andere Aktivitaeten abgeschlossen sind. Die Voraussetzungs-Aktivitaeten muessen vorher mit moodle_set_completion konfiguriert worden sein. Mehrere cmids werden per AND oder OR verknuepft.",
    inputSchema: {
      type: "object",
      properties: {
        cmid: {
          type: "number",
          description: "Course Module ID der zu sperrenden Aktivitaet",
        },
        require_cmids: {
          type: "array",
          items: { type: "number" },
          description: "cmids die abgeschlossen sein muessen",
        },
        show_locked: {
          type: "number",
          description:
            "1=ausgegraut anzeigen (Standard), 0=komplett verstecken",
          default: 1,
        },
        operator: {
          type: "string",
          description:
            "AND=alle Bedingungen muessen erfuellt sein, OR=eine reicht",
          default: "AND",
        },
      },
  ...
  },
  {
    ...
    description:
      "Gibt alle Abschnitte eines Moodle-Kurses zurück (Name, Nummer, ID).",
    inputSchema: {
      type: "object",
      properties: {
        courseid: {
          type: "number",
          description: "Die Kurs-ID (steht in der URL: ?id=XX)",
        },
      },
      required: ["courseid"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sectionnum: {
          type: "number",
          description: "Abschnittsnummer (0-basiert)",
        },
        name: {
          type: "string",
          description: "Name des Abschnitts, z.B. 'LS 7.2 – ESP32 Webserver'",
        },
        summary: {
          type: "string",
          description:
            "HTML-Inhalt der Abschnittsbeschreibung (Handlungssituation-Card)",
        },
      },
  ...
  },
  {
    ...
    description:
      "Erstellt eine Textseite (mod_page) in einem Kursabschnitt. NUR für Inhalte die Schüler nur LESEN (Infoblätter, Leitfäden, Phasen-Header).",
    inputSchema: {
      type: "object",
      properties: {
        courseid: { type: "number", description: "Kurs-ID" },
        ...
        visible: {
          type: "number",
          description: "1 = sichtbar (Standard), 0 = versteckt",
          default: 1,
        },
      },
  ...
  },
  {
    ...
    description:
      "Erstellt ein Text- und Medienfeld (mod_label) – wird direkt auf der Kursseite angezeigt, ohne eigenen Titel. Ideal für farbige Phasen-Header (Phase 1 Informieren, Phase 2 Planen usw.).",
    inputSchema: {
      type: "object",
      properties: {
        courseid: { type: "number", description: "Kurs-ID" },
        ...
        content: {
          type: "string",
          description: "HTML-Inhalt des Labels (z.B. farbiger Phasen-Header)",
        },
        visible: {
          type: "number",
          description: "1 = sichtbar (Standard), 0 = versteckt",
  ...
  },
  {
    ...
    description:
      "Erstellt einen Link zu einer externen Webseite (mod_url) in einem Kursabschnitt. Für Dokumentationen, GitHub-Repos, MDN, Arduino-Referenzen usw.",
    inputSchema: {
      type: "object",
      properties: {
        courseid: { type: "number", description: "Kurs-ID" },
        ...
        name: {
          type: "string",
          description:
            "Anzeigename des Links, z.B. 'Dokumentation: Arduino ESP32 (Espressif GitHub)'",
        },
        externalurl: {
          type: "string",
        ...
        intro: {
          type: "string",
          description: "Kurze Beschreibung des Links (optional)",
          default: "",
        },
        visible: {
          type: "number",
  ...
  },
  {
    ...
    description:
      "Erstellt eine Aufgabe (mod_assign) in einem Kursabschnitt. Verwenden wenn Schüler etwas abgeben/ausfüllen sollen (Arbeitsblätter, Reflexionen, Checklisten).",
    inputSchema: {
      type: "object",
      properties: {
        courseid: { type: "number", description: "Kurs-ID" },
        ...
        description: {
          type: "string",
          description: "HTML-Beschreibung der Aufgabe",
        },
        duedate: {
          type: "number",
          description: "Abgabedatum als Unix-Timestamp (0 = kein Datum)",
          default: 0,
        },
        maxfiles: {
          type: "number",
          description: "Max. Datei-Uploads (1 = Standard, 0 = kein Upload)",
          default: 1,
        },
        visible: {
          type: "number",
